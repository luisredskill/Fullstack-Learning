                     ...
                     //   Console.WriteLine($"Digite o numero");
                      ...
                      //  }
                       ...
                       // listaPf.Add(novaPf);
                        ...
                        // Criação de arquivo txt com informações
                        //StreamWriter sw = new StreamWriter($"{novaPf.nome}.txt"); // cria um arquivo de texto 
                        //sw.WriteLine(novaPf.nome); // escreve no arquivo de texto
                       // sw.Close(); // fecha o arquivo de texto

                        using (StreamWriter sw = new StreamWriter($"{novaPf.nome}.txt"))// ele para de usar o recurso que está entre parenteses assim que o que está entre colchetes é executado, ele garante que voce nao esqueca de fechar o arquivo
                        {
           ...
           //  Thread.Sleep(3000);
                ...
                //            }
                 ...
                 //       else
                  ...
                  //          Thread.Sleep(3000);
                  //    }
                    using (StreamReader sr = new StreamReader("Luis.txt")) // cria uma instancia de leitura de arquivos especificando o nome do arquivo
                    {
                        string linha;
                        while ((linha = sr.ReadLine()) != null) // le a primeira linha e verifica se o conteudo e diferente de nulo
                        {
                            Console.WriteLine($"{linha}"); // escreve o conteudo da linha
                            Console.ReadLine();
                        }
                    }
